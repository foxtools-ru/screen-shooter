...
Public NotInheritable Class AboutBox
  ...
  Private Sub AboutBox_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    Me.Text = String.Format("{0} v.{1}", Me.Text, My.Application.Info.Version)
    Me.LabelVersion.Text = String.Format("{0} {1}", Me.LabelVersion.Text, My.Application.Info.Version.ToString)
  End Sub
