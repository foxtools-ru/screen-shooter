...
'--------------------------------------------------------------------------------
Public Class ConfigShapeForm
  Inherits Form

  'base form for the Shapes/Tools configuration windows
  'базовая форма для конфигураций фигур/инструментов рисования

  Private Sub Config_KeyUp(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
