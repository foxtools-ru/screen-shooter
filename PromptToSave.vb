...
Public Class PromptToSave
  ...
  Private Sub PromptToSave_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    If chkDontShowAgain.Checked Then
      My.Settings.PromptToSave = False
      My.Settings.Save()
    End If
  End Sub
